...
function Post({ post }: Props) {
  ...
  return (
    <main>
      <Header />
      <img
        className="h-52 w-full object-cover md:h-72 lg:h-96"
        ...
        <div className="mt-10">
          <PortableText
            ...
            serializers={{
              ...
              li: ({ children }: any) => {
                ;<li className="ml-3 list-disc">{children}</li>
              },
        ...
        >
          ...
          <label>
            ...
            <textarea
              ...
              className="block w-full rounded border py-2 px-3 shadow outline-none ring-yellow-500 focus:ring"
          ...
          <input
            type="submit"
            className="focus:shadow-outline mt-10 bg-yellow-500 py-2 px-4 font-bold text-white shadow hover:cursor-pointer hover:bg-yellow-400 focus:outline-none"
          />
        </form>
      )}
